...
app_vnm.controller('ctrl-portout', function($scope, $rootScope, $translate, $compile, $timeout, $uibModal, $location, $window, FileUploader, $filter,
	...
	// danh sách bản tin chuyển mạng đi - số đẹp
	searchListNPRPortOutNiceNumber = function(data) {
		var url = eim_url + "/bs/mnp_port_out/list_subscriber_nice_number";
	...
	$scope.searchListNPRPortOut = function() {
		...
		searchListNPRPortOutNiceNumber(searchInput);
	}
