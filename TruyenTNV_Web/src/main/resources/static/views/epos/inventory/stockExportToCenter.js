...
app_vnm
		.controller(
				...
				function($scope, $rootScope, $translate, $compile, $timeout, $uibModal, $location, $window, FileUploader, $filter, $http, NgTableParams,
					...
					window.document.title = $translate.instant('vnm.stock_export_to_center.page.title');
					...
					$scope.loadDefault = function() {
						...
						$scope.model.reasonCode = $translate.instant("vnm.stock_export_to_center.text.reason.value.code");
						$scope.model.reasonName = $translate.instant("vnm.stock_export_to_center.text.reason.value.name");
