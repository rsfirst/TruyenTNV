...
public class CommonConstant
{
	...
	public static final int INDEX_SUB_IMGID = 20;
	public static final int INDEX_SUB_IMGID_2 = 21;
	public static final int INDEX_SUB_BUS_PERMIT_NO_IMG1 = 22;
	//DatBD2 update
	public static final int INDEX_SUB_BUS_PERMIT_NO_IMG2=23;
	public static final int INDEX_SUB_PARENT_IMG=24;
	//end
	public static final int INDEX_SUB_AUTHORIZED_IMG = 25;
	public static final int INDEX_SUB_FILEID = 26;
	public static final int INDEX_SUB_FILEID_2 = 27;
	public static final int INDEX_SUB_CONTRACT_IMG1 = 28;
	public static final int INDEX_SUB_CONTRACT_IMG2 = 29;
	public static final int INDEX_SUB_CUST_IMG = 30;
