...
@Controller
public class TransShopNonHieController {

	private static final Logger LOG = LoggerFactory.getLogger(TransShopNonHieController.class);
	...
	@RequestMapping(value = Constants.ACTION_TRANSSHOPNONHIE_SEARHALLGOODS, method = RequestMethod.POST)
	public ResponseEntity<?> searhAllGoods(HttpServletRequest request,
		...
		try {
			...
			String url = ev.getProperty("login.url") + Constants.REQUEST_MAPPING.ACTION_TRANSSHOPNONHIE_SEARHALLGOODS;
	...
	@RequestMapping(value = Constants.ACTION_TRANSSHOPNONHIE_SEARHGOODSONSTOCK, method = RequestMethod.POST)
	...
	public ResponseEntity<?> searhGoodsOnStock(HttpServletRequest request, @RequestParam(name = "shopId") String shopId,
		...
		try {
			...
			String url = ev.getProperty("login.url")
					+ Constants.REQUEST_MAPPING.ACTION_TRANSSHOPNONHIE_SEARHGOODSONSTOCK;
			String tmp = webService.apiServiceMethodGETWithParam(request, url, "", "", params);
			if (!"".equals(tmp)) {
				ObjectMapper jsonMapper = new ObjectMapper();
				try {
	...
	@RequestMapping(value = Constants.ACTION_TRANSSHOPNONHIE_SEARHGOODSONSTOCKTAB52, method = RequestMethod.POST)
	@PreAuthorize("eimSecured('" + Constants.ITEM_CODE.APPROVE_PURCHASE_ORDER_FOR_BS + "')")
	public ResponseEntity<?> searhGoodsOnStockTab52(HttpServletRequest request,
		...
		try {
			...
			String url = ev.getProperty("login.url")
					+ Constants.REQUEST_MAPPING.ACTION_TRANSSHOPNONHIE_SEARHGOODSONSTOCKTAB52;
			String tmp = webService.apiServiceMethodGETWithParam(request, url, "", "", params);
			if (!"".equals(tmp)) {
				ObjectMapper jsonMapper = new ObjectMapper();
				try {
	...
	@RequestMapping(value = Constants.ACTION_TRANSSHOPNONHIE_GETALLSTAFF, method = RequestMethod.POST)
	public ResponseEntity<?> getAllChildStaff(HttpServletRequest request, @RequestParam(name = "shopId") String shopId,
		...
		try {
			...
			String url = ev.getProperty("login.url") + Constants.REQUEST_MAPPING.ACTION_TRANSSHOPNONHIE_GETALLSTAFF;
			String tmp = webService.apiServiceMethodGETWithParam(request, url, "", "", params);
			if (!"".equals(tmp)) {
				ObjectMapper jsonMapper = new ObjectMapper();
				try {
	...
	@RequestMapping(value = Constants.ACTION_TRANSSHOPNONHIE_GETLISTINTERNALSTOCK, method = RequestMethod.POST)
	public ResponseEntity<?> getListInternalStock(HttpServletRequest request) {
		...
		try {
			String url = ev.getProperty("login.url")
					+ Constants.REQUEST_MAPPING.ACTION_TRANSSHOPNONHIE_GETLISTINTERNALSTOCK;
	...
	@RequestMapping(value = Constants.ACTION_TRANSSHOPNONHIE_GETGOODDETAIL, method = RequestMethod.POST)
	public ResponseEntity<?> getGoodDetail(HttpServletRequest request, @RequestParam(name = "shopId") String shopId,
		...
		try {
			...
			params.put("internalStockId", internalStockId);
			String url = ev.getProperty("login.url") + Constants.REQUEST_MAPPING.ACTION_TRANSSHOPNONHIE_GETGOODDETAIL;
			String tmp = webService.apiServiceMethodGETWithParam(request, url, "", "", params);
			if (!"".equals(tmp)) {
				ObjectMapper jsonMapper = new ObjectMapper();
				try {
