 ...
 */
@Entity
public class NprRerverSalOutput implements Serializable {
	...
	public String toString() {
		return "NprRerverSalOutput [nprSubscriberId=" + nprSubscriberId + ", violationFlag=" + violationFlag
				+ ", violationReason=" + violationReason + ", violationStatus=" + violationStatus
				+ ", vnmViolationStatus=" + vnmViolationStatus + ", accountType=" + accountType
				+ ", subdataCcontactNumber=" + subdataCcontactNumber + ", originalCCHTransID=" + originalCCHTransID
				+ ", cchTransId=" + cchTransId + ", createdDateNpr=" + createdDateNpr + ", createdDateNprStr="
				+ createdDateNprStr + ", createdDateViolation=" + createdDateViolation + ", accountTypeStr="
				+ accountTypeStr + ", msisdn=" + msisdn + ", primary=" + primary + ", violationStatusIndex="
				+ violationStatusIndex + "]";
	}
