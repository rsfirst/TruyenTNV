...
public class GoodDetailInput 
{
	...
	public GoodDetailInput()
	{
		
	}
	public GoodDetailInput copyGoodDetailOutput()
	{
		GoodDetailInput object = new GoodDetailInput(getStock_id(),getGoods_id(),getState_id(),getQuantity_issue(),
				getQuantity_effect(),getQuantity_remain());
		object.setGoods_code(getGoods_code());
		object.setGoods_name(getGoods_name());
		return object;
	}
	public GoodDetailInput(long stock_id, long goods_id, long state_id, long quantity_issue, long quantity_effect,
