...
public abstract class CharacterEncoder
{
	...
	abstract void encodeAtom(OutputStream outputstream, byte abyte0[], int i, int j) throws IOException;
	...
	protected static int readFully(InputStream inputstream, byte abyte0[]) throws IOException
	{
