...
public class ClientConsumerConfig
{
	...
	public static Invocation.Builder appendBuilder(TransEntity transEntity, Invocation.Builder builder, String strMediaType)
	{
		if (strMediaType != null)
		{
		...
		String key = ConsumerPropeties.getPath("httpheaders.authorization.basic");
		if (key != null)
		{
			builder.header(HttpHeaders.AUTHORIZATION, "Basic " + key);
		}
		return builder;
	}
